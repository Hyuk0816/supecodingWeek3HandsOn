public class Main {
    public static void main(String[] args) {
        ...
        SneakersPackageInfo nikeSneakersPackageInfo = staff.orderNikeSneakersToDeliverManager(deliveryManager);
        staff.sayNikePackageInfo(nikeSneakersPackageInfo);
        long deliverCost = staff.caculateDeliveryCost(nikeSneakersPackageInfo);
        ...
        customer.sayOrder();
        SneakersPackage SneakersPackage = deliveryManager.makeSneakersPacakage();
        long deliveryCost = customer.askDeliveryCostFromDeliveryManger(deliveryManager);
